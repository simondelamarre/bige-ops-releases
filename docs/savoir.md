# Ce que bige-ops sait — et ce qu’il ne sait pas toujours

- **Sait** : estimate sur catalogue public embarqué, topologies (mono-VM / multi-VM, OKS, OOS), materialization.
- **Ne sait pas toujours** : pricing commercial / négo, capacités d’offre qui évoluent.
