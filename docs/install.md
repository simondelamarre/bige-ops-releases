...
App desktop locale et gratuite, version **0.6.1**. Distribution via GitHub Releases : [simondelamarre/bige-ops-releases](https://github.com/simondelamarre/bige-ops-releases).
